function Footer() {
  return (
    <footer className="bg-gray-900 border-t border-gray-800 py-10 px-6 flex flex-col items-center gap-6">


      <p className="text-gray-500 text-sm text-center max-w-md">
        Conectando profissionais ao mercado offshore com mentoria especializada.
      </p>
      ...
      <p className="text-gray-600 text-xs">
        © 2025 Uptime Consultoria. Todos os direitos reservados.
      </p>
